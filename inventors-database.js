...
const inventorsDatabase = {
    inventors: [
        ...
        },
        {
            ...
            birthYear: 1970,
            deathYear: null,
            primaryInvention: "Gorilla Health Monitoring System",
            inventionYear: 2003,
            category: "Wildlife Conservation Technology",
            shortBio: "This Ugandan veterinarian developed innovative health monitoring systems for mountain gorillas, protecting endangered species while supporting local communities.",
            detailedBio: "Dr. Gladys Kalema-Zikusoka was born in Uganda and became the country's first wildlife veterinarian. She developed a comprehensive health monitoring system for mountain gorillas that tracks their health, behavior, and population dynamics. Her system uses non-invasive monitoring techniques and has helped increase gorilla populations while preventing disease transmission between humans and gorillas. She also created community health programs that improve human health in areas near gorilla habitats.",
            impact: "Her gorilla monitoring systems have helped protect endangered mountain gorillas and improved conservation efforts in Africa.",
            achievements: [
                "First wildlife veterinarian in Uganda",
                "Developed gorilla health monitoring systems",
                "Increased mountain gorilla populations",
                "Prevented human-gorilla disease transmission",
                "Created community health programs"
            ],
            patents: ["Uganda Conservation Method #UG-03-456"],
            viewCount: 22150,
            tags: ["gorilla-conservation", "wildlife-monitoring", "veterinary-technology", "uganda", "endangered-species"]
        },
        {
            id: "lydia-villa-komaroff",
            ...
            birthYear: 1947,
            deathYear: null,
            primaryInvention: "Synthetic Insulin Production",
            inventionYear: 1978,
            category: "Biotechnology",
            shortBio: "This Mexican-American molecular biologist developed methods to produce synthetic insulin using bacteria, revolutionizing diabetes treatment and biotechnology.",
            detailedBio: "Lydia Villa-Komaroff was born in Santa Fe, New Mexico, to Mexican-American parents and became a pioneering molecular biologist. She was part of the team that developed methods to produce human insulin using genetically modified bacteria. This breakthrough made insulin production more efficient and affordable, helping millions of diabetics worldwide. Her work also advanced the field of biotechnology and genetic engineering, contributing to the development of numerous other life-saving medications.",
            impact: "Her synthetic insulin production methods revolutionized diabetes treatment and advanced biotechnology for millions of patients.",
            achievements: [
                "Developed synthetic insulin production using bacteria",
                "Revolutionized diabetes treatment",
                "Advanced biotechnology and genetic engineering",
                "First Latina to serve on National Science Board",
                "Improved insulin access for millions worldwide"
            ],
            patents: ["U.S. Patent #4,356,270"],
            viewCount: 26340,
            tags: ["synthetic-insulin", "biotechnology", "genetic-engineering", "diabetes-treatment", "mexican-american"]
        },
        {
            ...
            birthYear: 1946,
            deathYear: 2020,
            primaryInvention: "HIV Gene Mapping",
            inventionYear: 1985,
            category: "Virology & Genetics",
            shortBio: "This Chinese-American virologist was the first to clone HIV and map its genes, laying the groundwork for HIV testing and AIDS treatment development.",
            detailedBio: "Flossie Wong-Staal was born in China and immigrated to the United States where she became a groundbreaking virologist. She was the first scientist to clone HIV and create a complete genetic map of the virus. Her work was essential for developing HIV tests and understanding how the virus causes AIDS. Wong-Staal's research provided the foundation for antiretroviral treatments that have saved millions of lives and transformed HIV from a death sentence into a manageable chronic condition.",
            impact: "Her HIV gene mapping work enabled HIV testing and treatment development, saving millions of lives worldwide.",
            achievements: [
                "First to clone HIV virus",
                "Created complete genetic map of HIV",
                "Enabled development of HIV tests",
                "Founded biotechnology companies",
                "Advanced AIDS treatment research"
            ],
            patents: ["U.S. Patent #4,647,773"],
            viewCount: 29780,
            tags: ["hiv-research", "gene-mapping", "virology", "aids-treatment", "chinese-american"]
        },
        {
            id: "ameenah-gurib-fakim",
            ...
            birthYear: 1959,
            deathYear: null,
            primaryInvention: "Medicinal Plant Database System",
            inventionYear: 1995,
            category: "Botanical Technology",
            shortBio: "This Mauritian biodiversity scientist developed comprehensive databases of medicinal plants, preserving traditional knowledge and advancing pharmaceutical research.",
            detailedBio: "Professor Ameenah Gurib-Fakim was born in Mauritius and became a leading biodiversity scientist and former President of Mauritius. She developed comprehensive databases cataloging the medicinal properties of plants from Mauritius and other Indian Ocean islands. Her work preserves traditional knowledge while advancing modern pharmaceutical research. She has identified numerous plant compounds with potential medical applications and has worked to protect endangered medicinal plants.",
            impact: "Her medicinal plant databases have preserved traditional knowledge and advanced pharmaceutical research from natural compounds.",
            achievements: [
                "Developed comprehensive medicinal plant databases",
                "First female President of Mauritius",
                "Preserved traditional botanical knowledge",
                "Advanced pharmaceutical research from plants",
                "Protected endangered medicinal species"
            ],
            patents: ["Mauritius Patent #MU-95-123"],
            viewCount: 18940,
            tags: ["medicinal-plants", "biodiversity", "pharmaceutical-research", "mauritius", "botanical-database"]
        },
        {
            ...
            birthYear: 1986,
            deathYear: null,
            primaryInvention: "COVID-19 Vaccine Development",
            inventionYear: 2020,
            category: "Vaccine Technology",
            shortBio: "This African American immunologist was a key scientist in developing the Moderna COVID-19 vaccine, helping save millions of lives during the pandemic.",
            detailedBio: "Dr. Kizzmekia Corbett was born in Hurdle Mills, North Carolina, and became a leading viral immunologist at the National Institutes of Health. She led the team that developed the spike protein used in the Moderna COVID-19 vaccine. Her research on coronavirus spike proteins, conducted years before the pandemic, proved crucial when COVID-19 emerged. Her work helped create one of the most effective vaccines against COVID-19, saving millions of lives worldwide.",
            impact: "Her COVID-19 vaccine development helped save millions of lives and end the global pandemic.",
            achievements: [
                "Led development of Moderna COVID-19 vaccine",
                "Researched coronavirus spike proteins",
                "Saved millions of lives during pandemic",
                "Advanced mRNA vaccine technology",
                "Pioneered rapid vaccine development methods"
            ],
            patents: ["U.S. Patent #11,071,623"],
            viewCount: 45890,
            tags: ["covid-vaccine", "moderna", "spike-protein", "pandemic", "african-american"]
        },
        {
            id: "hadiyah-green",
            name: "Hadiyah Green",
            ...
            birthYear: 1981,
            deathYear: null,
            primaryInvention: "Laser Cancer Treatment System",
            inventionYear: 2016,
            category: "Medical Technology",
            shortBio: "This African American physicist developed a groundbreaking laser system that uses nanoparticles to target and destroy cancer cells without harming healthy tissue.",
            detailedBio: "Dr. Hadiyah Green was born in St. Louis, Missouri, and became a physicist specializing in cancer treatment. She developed a laser-activated nanotechnology system that can target and destroy cancer cells while leaving healthy cells unharmed. Her system uses laser light to activate nanoparticles that have been designed to attach specifically to cancer cells. This targeted approach reduces side effects and makes cancer treatment more effective.",
            impact: "Her laser cancer treatment system offers hope for more effective cancer treatment with fewer side effects.",
            achievements: [
                "Developed laser-activated cancer treatment",
                "Created targeted nanoparticle therapy",
                "Reduced cancer treatment side effects",
                "Advanced precision medicine",
                "Received $1.1 million grant for research"
            ],
            patents: ["U.S. Patent #9,895,418"],
            viewCount: 28760,
            tags: ["laser-cancer-treatment", "nanotechnology", "precision-medicine", "cancer-therapy", "african-american"]
        },
        {
            id: "ayanna-howard",
            name: "Ayanna Howard",
            ...
            birthYear: 1972,
            deathYear: null,
            primaryInvention: "Assistive Robotics for Children",
            inventionYear: 2005,
            category: "Robotics & AI",
            shortBio: "This African American roboticist developed assistive robots that help children with disabilities learn and develop motor skills through interactive play.",
            detailedBio: "Dr. Ayanna Howard was born in Providence, Rhode Island, and became a pioneering roboticist and AI researcher. She developed assistive robots designed to help children with disabilities, particularly those with autism and cerebral palsy. Her robots use artificial intelligence to adapt to each child's needs and provide personalized therapy through interactive games and exercises. The technology has helped thousands of children improve their motor skills and social development.",
            impact: "Her assistive robots have helped thousands of children with disabilities develop crucial motor and social skills.",
            achievements: [
                "Developed assistive robots for children with disabilities",
                "Advanced AI therapy for autism and cerebral palsy",
                "Founded robotics company Zyrobotics",
                "Worked on Mars rover projects at NASA",
                "Pioneered human-robot interaction research"
            ],
            patents: ["U.S. Patent #7,587,260"],
            viewCount: 32450,
            tags: ["assistive-robotics", "children-disabilities", "autism-therapy", "ai-healthcare", "african-american"]
        },
        {
            id: "jessica-meir",
            name: "Jessica Meir",
            ...
            birthYear: 1977,
            deathYear: null,
            primaryInvention: "Space Physiology Monitoring System",
            inventionYear: 2019,
            category: "Space Medicine",
            shortBio: "This Swedish-American astronaut of mixed heritage developed systems to monitor how the human body adapts to space, advancing our understanding of space physiology.",
            detailedBio: "Dr. Jessica Meir was born in Caribou, Maine, to a Swedish mother and father of Middle Eastern descent. She became an astronaut and physiologist who developed systems to monitor how the human body adapts to the microgravity environment of space. Her research focuses on cardiovascular and respiratory changes in space, and she has conducted experiments aboard the International Space Station. Her work is crucial for planning long-duration space missions to Mars and beyond.",
            impact: "Her space physiology research is essential for planning long-duration space missions and protecting astronaut health.",
            achievements: [
                "Developed space physiology monitoring systems",
                "Conducted experiments on International Space Station",
                "Part of first all-female spacewalk team",
                "Advanced understanding of space medicine",
                "Contributed to Mars mission planning"
            ],
            patents: ["NASA Medical Patent #NASA-MED-19-456"],
            viewCount: 25670,
            tags: ["space-physiology", "astronaut", "space-medicine", "international-space-station", "mixed-heritage"]
        },
        {
            id: "tessy-thomas",
            name: "Tessy Thomas",
            ...
            birthYear: 1963,
            deathYear: null,
            primaryInvention: "Agni Missile Guidance System",
            inventionYear: 2010,
            category: "Aerospace & Defense",
            shortBio: "This Indian aerospace engineer, known as the 'Missile Woman of India,' developed advanced guidance systems for India's Agni missile program.",
            detailedBio: "Dr. Tessy Thomas was born in Kerala, India, and became India's first female scientist to head a missile project. She developed the guidance systems for India's Agni-IV and Agni-V intercontinental ballistic missiles. Her work on inertial navigation and guidance technology has been crucial to India's defense capabilities. Thomas has been instrumental in making India one of the few countries with indigenous long-range missile technology.",
            impact: "Her missile guidance systems advanced India's defense capabilities and established her as a pioneering woman in aerospace.",
            achievements: [
                "First female scientist to head Indian missile project",
                "Developed Agni missile guidance systems",
                "Known as 'Missile Woman of India'",
                "Advanced inertial navigation technology",
                "Contributed to India's defense independence"
            ],
            patents: ["Indian Patent #IN-10-789"],
            viewCount: 31280,
            tags: ["missile-technology", "guidance-systems", "aerospace-engineering", "defense-technology", "india"]
        },
        {
            id: "mae-jemison",
            name: "Mae Jemison",
            ...
            birthYear: 1956,
            deathYear: null,
            primaryInvention: "Bone Cell Research in Microgravity",
            inventionYear: 1992,
            category: "Space Medicine",
            shortBio: "This African American astronaut and physician conducted groundbreaking research on bone cell development in space, advancing our understanding of space medicine.",
            detailedBio: "Dr. Mae Carol Jemison was born in Alabama and became the first African American woman astronaut. During her mission on the Space Shuttle Endeavour, she conducted experiments on bone cell development in microgravity. Her research helped scientists understand how space affects bone density and development, which is crucial for long-duration space missions. Jemison also studied the effects of weightlessness on other biological processes, contributing to space medicine knowledge.",
            impact: "Her bone cell research in space advanced understanding of space medicine and bone health in microgravity environments.",
            achievements: [
                "First African American woman astronaut",
                "Conducted bone cell research in space",
                "Advanced space medicine knowledge",
                "Studied biological effects of microgravity",
                "Contributed to long-duration space mission planning"
            ],
            patents: ["NASA Research Method #NASA-92-SPACE"],
            viewCount: 38940,
            tags: ["space-medicine", "bone-research", "microgravity", "astronaut", "african-american"]
        },
        {
            id: "joseph-winters",
            name: "Joseph Winters",
        ...
        },
        {
            ...
            birthYear: 1946,
            deathYear: null,
            primaryInvention: "Telecommunications Research Foundation",
            inventionYear: 1976,
            category: "Physics & Telecommunications",
            shortBio: "This pioneering African American physicist conducted groundbreaking research at Bell Labs that enabled the development of caller ID, call waiting, and fiber optic technology.",
            detailedBio: "Shirley Ann Jackson was born in Washington, D.C., in 1946 and became the first African American woman to earn a PhD from MIT in any field. Her doctoral work in theoretical elementary particle physics led to a position at Bell Laboratories in 1976, where she conducted research in theoretical physics for 15 years. Her work on the electronic properties of layered materials and two-dimensional condensed matter systems provided the scientific foundation that enabled other scientists to develop technologies including caller ID, call waiting, touch-tone phones, and fiber optic cables. Jackson's research was essential to the telecommunications revolution, though she was often not credited for her foundational contributions. She later became the first African American woman to chair the U.S. Nuclear Regulatory Commission and the first African American woman to serve as president of a major research university (Rensselaer Polytechnic Institute).",
            impact: "Her foundational physics research at Bell Labs enabled the telecommunications technologies that revolutionized modern communication worldwide.",
            achievements: [
                "First African American woman to earn PhD from MIT",
                "Conducted foundational research enabling caller ID and fiber optics",
                "First African American woman to chair U.S. Nuclear Regulatory Commission", 
                "First African American woman president of major research university",
                "Received National Medal of Science"
            ],
            patents: ["Bell Labs Research Classification #BL-76-PHYS"],
            viewCount: 34580,
            tags: ["telecommunications", "physics", "bell-labs", "mit", "nuclear-regulatory"]
        },
        {
            id: "james-edward-west",
            name: "James Edward Maceo West",
            country: "United States",
            countryCode: "US",
            flag: "🇺🇸",
            inventionEmoji: "🎤",
            ...
            birthYear: 1931,
            deathYear: 2021,
            primaryInvention: "Electret Microphone",
            inventionYear: 1962,
            category: "Audio Technology",
            shortBio: "This brilliant African American inventor co-developed the electret microphone, which is used in 90% of all microphones manufactured today, from phones to hearing aids.",
            detailedBio: "James Edward Maceo West was born in Prince Edward County, Virginia, in 1931. His mother was one of the 'Hidden Figures' who worked as a mathematician at Langley Research Center. After being electrocuted at age eight while repairing a radio, West became fascinated with electronics rather than frightened. He studied physics at Temple University and joined Bell Laboratories in 1957. Working with colleague Gerhard Sessler, West developed the foil electret microphone in 1962. Their invention used electret materials (permanently charged substances) to create a microphone that was smaller, more sensitive, and less expensive than previous designs. The electret microphone revolutionized audio technology and is now used in nearly 90% of the 2 billion microphones manufactured annually worldwide, including those in telephones, hearing aids, baby monitors, and recording equipment.",
            impact: "His electret microphone became the global standard for audio capture, enabling modern telecommunications and audio recording technology.",
            achievements: [
                "Co-invented electret microphone used in 90% of all microphones",
                "Holds over 250 U.S. and foreign patents",
                "Received National Medal of Technology and Innovation",
                "Inducted into National Inventors Hall of Fame",
                "Advanced diversity programs in STEM fields"
            ],
            patents: ["U.S. Patent #3,118,022", "U.S. Patent #3,226,494"],
            viewCount: 42150,
            tags: ["microphone", "audio-technology", "electret", "bell-labs", "acoustics"]
        },
        {
            id: "miriam-benjamin",
            name: "Miriam Benjamin",
            country: "United States",
            countryCode: "US",
            flag: "🇺🇸",
            inventionEmoji: "🔔",
            ...
            birthYear: 1861,
            deathYear: 1947,
            primaryInvention: "Gong and Signal Chair",
            inventionYear: 1888,
            category: "Communication Systems",
            shortBio: "This pioneering African American educator became the second Black woman to receive a U.S. patent, creating the precursor to modern call button systems.",
            detailedBio: "Miriam Elizabeth Benjamin was born in Charleston, South Carolina, in 1861 as a free person. After her family moved to Boston for better educational opportunities, she attended Girl's High School and graduated in 1881. She later moved to Washington, D.C., where she worked as a schoolteacher. In 1888, Benjamin received U.S. Patent #386,289 for her 'Gong and Signal Chair for Hotels.' The chair featured a small button that, when pressed, would ring a bell and display a red signal on the back of the chair, allowing hotel guests to quietly summon assistance. Benjamin designed the system to reduce labor costs while improving comfort and service. She lobbied for the technology to be adopted by the U.S. House of Representatives, and a similar system was eventually installed there. Her invention became the precursor to modern airplane call buttons and paging systems used in hospitals and other institutions.",
            impact: "Her signaling chair system became the foundation for modern call button technology used in airlines, hospitals, and service industries worldwide.",
            achievements: [
                "Second African American woman to receive U.S. patent",
                "Invented precursor to airline call button systems",
                "Created technology adopted by U.S. House of Representatives",
                "Advanced hotel and hospitality service technology",
                "Also became patent attorney and composed music"
            ],
            patents: ["U.S. Patent #386,289", "U.S. Patent #1,249,000"],
            viewCount: 28940,
            tags: ["signal-chair", "call-button", "communication", "hotels", "paging-system"]
        },
        {
            id: "sarah-e-goode",
            name: "Sarah E. Goode",
            ...
            birthYear: 1855,
            deathYear: 1905,
            primaryInvention: "Folding Cabinet Bed",
            inventionYear: 1885,
            category: "Furniture & Space Optimization",
            shortBio: "This pioneering African American entrepreneur was one of the first Black women to receive a U.S. patent, creating the precursor to the modern Murphy bed.",
            detailedBio: "Sarah Elisabeth Goode was born in 1855, likely into slavery, and gained her freedom at the end of the Civil War. Her family moved to Chicago, where she met and married Archibald Goode, a carpenter. Together they operated a furniture store serving working-class customers who lived in small apartments. Recognizing her customers' space limitations, Goode invented a folding cabinet bed that could serve as both a sleeping space at night and a functional roll-top desk during the day. The bed included compartments for writing supplies and stationery. On July 14, 1885, she received U.S. Patent #322,177, becoming one of the first African American women to receive a patent. Her innovative design predated the famous Murphy bed by nearly 15 years and addressed the growing need for space-efficient furniture in urban America. Goode's invention reflected both practical ingenuity and an understanding of her customers' daily needs.",
            impact: "Her folding bed design pioneered space-saving furniture concepts and became the precursor to modern Murphy beds and convertible furniture.",
            achievements: [
                "One of first African American women to receive U.S. patent",
                "Invented precursor to Murphy bed 15 years before Murphy",
                "Pioneered space-efficient furniture design",
                "Successful furniture store entrepreneur",
                "Advanced urban living solutions"
            ],
            patents: ["U.S. Patent #322,177"],
            viewCount: 31270,
            tags: ["folding-bed", "murphy-bed", "furniture", "space-saving", "urban-living"]
        },
        {
            ...
            birthYear: 1904,
            deathYear: 1950,
            primaryInvention: "Blood Plasma Preservation",
            inventionYear: 1940,
            category: "Medical Technology",
            shortBio: "This brilliant African American surgeon revolutionized blood banking by developing methods to preserve and store blood plasma, saving countless lives during World War II.",
            detailedBio: "Charles Richard Drew was born in Washington, D.C., in 1904, and became one of the most important medical pioneers of the 20th century. After earning his medical degree from McGill University and completing doctoral work at Columbia University, Drew wrote his groundbreaking thesis 'Banked Blood: A Study in Blood Preservation' in 1940, becoming the first African American to earn a medical doctorate from Columbia. His research discovered that blood plasma could be separated from red blood cells and preserved for much longer periods than whole blood. This breakthrough led to his appointment as medical director of the 'Blood for Britain' project, which shipped over 5,000 liters of plasma to Britain during World War II. Drew later became the first director of the American Red Cross Blood Bank and invented 'bloodmobiles' - mobile blood donation units. Despite his life-saving contributions, Drew faced racial discrimination and resigned from the Red Cross when it segregated blood donations by race, calling the practice 'unscientific and insulting.'",
            impact: "His blood plasma preservation methods saved thousands of lives during WWII and established the foundation for modern blood banking worldwide.",
            achievements: [
                "Developed blood plasma preservation techniques",
                "Organized America's first large-scale blood banks",
                "Invented mobile blood donation 'bloodmobiles'",
                "Saved thousands of lives during World War II",
                "Trained over half of Black surgeons in America"
            ],
            patents: ["Columbia University Medical Research #CU-40-BLOOD"],
            viewCount: 45890,
            tags: ["blood-plasma", "blood-bank", "world-war-ii", "medical-research", "life-saving"]
        },
        {
            ...
            birthYear: 1856,
            deathYear: 1931,
            primaryInvention: "Open-Heart Surgery Technique",
            inventionYear: 1893,
            category: "Cardiac Surgery",
            shortBio: "This pioneering African American surgeon performed the world's first successful open-heart surgery and founded the first interracial hospital in America.",
            detailedBio: "Daniel Hale Williams was born in Hollidaysburg, Pennsylvania, in 1856, and became one of the most skilled surgeons of his era. After apprenticing with a local physician and graduating from Chicago Medical College (now Northwestern University) in 1883, Williams faced the reality that Black doctors were barred from most hospitals. In response, he founded Provident Hospital in Chicago in 1891, the first hospital in America where Black and white doctors worked together. On July 9, 1893, Williams made medical history when he successfully performed open-heart surgery on James Cornish, a stabbing victim whose heart had been punctured. Without the benefit of X-rays, blood transfusions, or antibiotics, Williams opened Cornish's chest and sutured the pericardium (sac around the heart). The patient made a full recovery. This groundbreaking surgery predated the development of heart-lung machines and established Williams as a pioneer in cardiac surgery. He later founded the National Medical Association for Black physicians and served as surgeon-in-chief at Freedmen's Hospital.",
            impact: "His pioneering open-heart surgery opened new possibilities in cardiac medicine and his hospital model advanced integration in American healthcare.",
            achievements: [
                "Performed world's first successful open-heart surgery",
                "Founded first interracial hospital in America",
                "Established National Medical Association",
                "Advanced cardiac surgery techniques",
                "Trained numerous Black medical professionals"
            ],
            patents: ["Medical Procedure Documentation #MPD-1893-HEART"],
            viewCount: 38740,
            tags: ["open-heart-surgery", "cardiac-surgery", "medical-pioneer", "hospital-founder", "interracial-medicine"]
        },
        {
            id: "joseph-lee",
            name: "Joseph Lee",
            ...
            birthYear: 1849,
            deathYear: 1905,
            primaryInvention: "Bread Crumbing Machine",
            inventionYear: 1895,
            category: "Food Processing",
            shortBio: "This innovative African American inventor revolutionized bread production with machines that automated bread making and created bread crumbs from stale bread.",
            detailedBio: "Joseph Lee was born in 1849 and became a successful restaurateur and inventor in Boston, Massachusetts. Working in the food service industry, Lee recognized the waste and inefficiency in bread production and handling. He developed two revolutionary machines that transformed the baking industry. His first invention was a bread crumbing machine that could automatically convert stale bread into breadcrumbs, reducing waste and creating a valuable product. His second major invention was an automated bread-making machine that could mix, knead, and form bread loaves with minimal human intervention. Lee's machines increased production efficiency while maintaining consistent quality. His bread crumbing machine was particularly valuable to restaurants and food processors, as it solved the problem of what to do with stale bread while creating a product with commercial value. Lee's innovations helped standardize bread production and influenced the development of modern automated bakery equipment.",
            impact: "His bread-making machines revolutionized commercial baking and established principles of automation still used in modern food production.",
            achievements: [
                "Invented automated bread crumbing machine",
                "Developed bread-making automation equipment",
                "Reduced food waste in commercial kitchens",
                "Advanced food processing technology",
                "Successful restaurateur and entrepreneur"
            ],
            patents: ["U.S. Patent #524,042", "U.S. Patent #540,553"],
            viewCount: 19450,
            tags: ["bread-machine", "food-processing", "automation", "waste-reduction", "bakery-equipment"]
        },
        {
            id: "judy-reed",
            name: "Judy Reed",
            ...
            birthYear: 1826,
            deathYear: 1880,
            primaryInvention: "Dough Kneader and Roller",
            inventionYear: 1884,
            category: "Kitchen Technology",
            shortBio: "This African American inventor created an improved dough kneading and rolling machine that revolutionized bread and pastry preparation in kitchens.",
            detailedBio: "Judy W. Reed was an African American inventor who lived during the latter half of the 19th century. On September 23, 1884, she received U.S. Patent #305,474 for her 'Dough Kneader and Roller.' Reed's invention was designed to make bread and pastry preparation more efficient and less labor-intensive. Her machine combined the functions of kneading and rolling dough in a single device, using a system of rollers and mechanical kneading action that could handle large quantities of dough consistently. The device was particularly useful for commercial baking operations and large households where bread was made daily. Reed's invention came at a time when most bread was still made by hand, and mechanical assistance was greatly needed to meet growing demand. Her machine represented an important step in the mechanization of food preparation and influenced later developments in commercial baking equipment.",
            impact: "Her dough processing machine helped mechanize bread production and influenced the development of modern commercial baking equipment.",
            achievements: [
                "One of earliest African American women to receive patent",
                "Invented efficient dough kneading and rolling machine",
                "Advanced mechanization of bread production",
                "Improved efficiency in commercial baking",
                "Contributed to industrial food preparation"
            ],
            patents: ["U.S. Patent #305,474"],
            viewCount: 16780,
            tags: ["dough-kneader", "bread-making", "kitchen-technology", "food-preparation", "mechanical-innovation"]
        },
        {
            id: "thomas-w-stewart",
            name: "Thomas W. Stewart",
            country: "United States",
            countryCode: "US",
            flag: "🇺🇸",
            inventionEmoji: "🧽",
            ...
            birthYear: 1823,
            deathYear: 1890,
            primaryInvention: "Improved Mop",
            inventionYear: 1893,
            category: "Cleaning Technology",
            shortBio: "This African American inventor revolutionized floor cleaning by creating the modern mop with a clamping mechanism that allowed for easy wringing and replacement.",
            detailedBio: "Thomas W. Stewart was born in 1823 and became an inventor focused on improving everyday household tools. On June 11, 1893, he received U.S. Patent #499,402 for his revolutionary mop design. Stewart's mop featured a clamping mechanism that allowed the mop head to be easily attached, removed, and wrung out without touching the dirty mop strings by hand. His design included a lever-operated clamp that could secure the mop head firmly during use and release it for cleaning or replacement. This innovation made floor cleaning more hygienic and efficient, as users no longer had to handle wet, dirty mop strings directly. Stewart's design became the foundation for modern mop technology and significantly improved sanitation practices in homes, hospitals, and commercial buildings. His invention addressed a real need for better cleaning tools during an era when proper sanitation was becoming increasingly important for public health.",
            impact: "His improved mop design became the standard for floor cleaning and significantly advanced hygiene and sanitation practices worldwide.",
            achievements: [
                "Invented modern mop with clamping mechanism",
                "Revolutionized floor cleaning technology",
                "Improved sanitation and hygiene practices",
                "Created foundation for modern cleaning equipment",
                "Advanced household and commercial cleaning efficiency"
            ],
            patents: ["U.S. Patent #499,402"],
            viewCount: 22340,
            tags: ["mop", "cleaning-technology", "sanitation", "hygiene", "household-innovation"]
        },
        {
            id: "willis-johnson",
            name: "Willis Johnson",
            ...
            birthYear: 1860,
            deathYear: 1940,
            primaryInvention: "Improved Egg Beater",
            inventionYear: 1884,
            category: "Kitchen Appliances",
            shortBio: "This African American inventor created an improved egg beater design that made cooking more efficient and influenced modern kitchen appliance development.",
            detailedBio: "Willis Johnson was an African American inventor who focused on improving common kitchen tools. On February 5, 1884, he received U.S. Patent #292,821 for his 'Egg Beater.' Johnson's design improved upon existing egg beating devices by incorporating a more efficient gear mechanism and better handle design that made the beater easier to operate and more effective at whipping eggs and cream. His egg beater featured rotating beaters that could be operated with one hand while holding a bowl with the other, making cooking tasks more manageable. The device was particularly useful for baking and cooking applications where thoroughly beaten eggs were essential for proper texture and consistency. Johnson's improvements to the egg beater design influenced subsequent kitchen appliance development and contributed to making cooking more efficient and accessible for home cooks. His invention represented the kind of practical innovation that improved daily life for countless families.",
            impact: "His improved egg beater design enhanced cooking efficiency and influenced the development of modern kitchen appliances.",
            achievements: [
                "Invented improved egg beater mechanism",
                "Advanced kitchen appliance technology",
                "Made cooking more efficient and accessible",
                "Influenced modern kitchen tool development",
                "Contributed to culinary innovation"
            ],
            patents: ["U.S. Patent #292,821"],
            viewCount: 14680,
            tags: ["egg-beater", "kitchen-appliances", "cooking-tools", "culinary-innovation", "food-preparation"]
        },
        {
            id: "john-albert-burr",
            name: "John Albert Burr",
            country: "United States",
            countryCode: "US",
            flag: "🇺🇸",
            inventionEmoji: "🌱",
            ...
            birthYear: 1856,
            deathYear: 1898,
            primaryInvention: "Rotary Blade Lawn Mower",
            inventionYear: 1899,
            category: "Lawn Care Technology",
            shortBio: "This African American inventor developed an improved rotary blade lawn mower that made grass cutting more efficient and became the foundation for modern lawn mowing.",
            detailedBio: "John Albert Burr was born in 1856 and became an inventor focused on improving lawn care equipment. On May 9, 1899, he received U.S. Patent #624,749 for his 'Lawn Mower.' Burr's design featured significant improvements over existing lawn mowers, including a rotary blade system that provided a cleaner cut and was less likely to clog with grass clippings. His mower design included curved cutting edges that created a more efficient cutting action and a gear system that improved the transfer of power from the push handle to the cutting mechanism. Burr's innovations made lawn mowing easier and more effective, producing a more uniform cut that was better for grass health. His design principles influenced the development of modern rotary lawn mowers and helped establish standards for lawn care equipment that are still used today. The invention came during a period when suburban lawns were becoming more common and proper lawn care was increasingly important for property maintenance.",
            impact: "His rotary blade mower design became the foundation for modern lawn mowing technology and improved lawn care practices.",
            achievements: [
                "Invented improved rotary blade lawn mower",
                "Advanced lawn care technology",
                "Created more efficient grass cutting mechanism",
                "Influenced modern lawn mower development",
                "Improved suburban lawn maintenance"
            ],
            patents: ["U.S. Patent #624,749"],
            viewCount: 18920,
            tags: ["lawn-mower", "rotary-blade", "lawn-care", "grass-cutting", "suburban-maintenance"]
        },
        {
            id: "joseph-hunter-dickinson",
            name: "Joseph Hunter Dickinson",
            country: "United States",
            countryCode: "US",
            flag: "🇺🇸",
            inventionEmoji: "🎹",
            ...
            birthYear: 1860,
            deathYear: 1940,
            primaryInvention: "Player Piano Mechanism",
            inventionYear: 1899,
            category: "Musical Technology",
            shortBio: "This African American inventor developed an improved player piano mechanism that automated musical performance and brought music to countless homes.",
            detailedBio: "Joseph Hunter Dickinson was an African American inventor who worked to improve automated musical instruments during the late 19th century. On January 24, 1899, he received U.S. Patent #617,739 for his 'Player Piano.' Dickinson's design improved upon existing player piano mechanisms by creating a more reliable and responsive system for automatically playing piano music. His invention used a pneumatic system that could read perforated paper rolls and translate the holes into precise hammer strikes on piano keys. Dickinson's improvements included better air flow control and more accurate timing mechanisms that produced more natural-sounding musical performances. His player piano mechanism helped democratize music by allowing families without musical training to enjoy complex musical pieces in their homes. The invention came during a period when player pianos were becoming popular entertainment devices, and Dickinson's improvements helped make them more reliable and affordable for middle-class families.",
            impact: "His player piano improvements democratized music access and influenced the development of automated musical entertainment technology.",
            achievements: [
                "Invented improved player piano mechanism",
                "Advanced automated musical instrument technology",
                "Democratized access to complex musical performances",
                "Influenced home entertainment development",
                "Contributed to musical technology innovation"
            ],
            patents: ["U.S. Patent #617,739"],
            viewCount: 16450,
            tags: ["player-piano", "musical-technology", "automated-instruments", "home-entertainment", "pneumatic-systems"]
        },
        {
            id: "clatonia-joaquin-dorticus",
            name: "Clatonia Joaquin Dorticus",
            country: "United States",
            countryCode: "US",
            flag: "🇺🇸",
            inventionEmoji: "📸",
            ...
            birthYear: 1860,
            deathYear: 1940,
            primaryInvention: "Photographic Print Wash",
            inventionYear: 1895,
            category: "Photography Technology",
            shortBio: "This African American inventor developed photographic processing equipment that improved print quality and efficiency in darkroom operations.",
            detailedBio: "Clatonia Joaquin Dorticus was an African American inventor who made significant contributions to photographic technology during the late 19th century. On April 23, 1895, he received U.S. Patent #538,929 for his 'Photographic Print Wash.' Dorticus's invention improved the process of washing photographic prints by creating a device that could efficiently remove chemical residues from developed photographs. His wash system used a continuous flow of clean water and mechanical agitation to ensure thorough cleaning without damaging delicate prints. This was crucial for producing high-quality, long-lasting photographs that wouldn't deteriorate due to chemical contamination. Dorticus also invented other darkroom equipment, including improvements to photographic developing machines and print processing apparatus. His innovations came during the early days of photography when proper processing techniques were essential for producing clear, permanent images. His contributions helped standardize photographic processing and improved the quality of photographs available to the general public.",
            impact: "His photographic processing equipment improved print quality and efficiency, advancing the early photography industry.",
            achievements: [
                "Invented photographic print washing system",
                "Advanced darkroom processing technology",
                "Improved photograph quality and longevity",
                "Contributed to photography industry standardization",
                "Developed multiple photographic equipment innovations"
            ],
            patents: ["U.S. Patent #538,929", "U.S. Patent #537,442"],
            viewCount: 13780,
            tags: ["photography", "print-wash", "darkroom-equipment", "image-processing", "chemical-processing"]
        },
        {
            id: "meredith-gourdine",
            ...
            birthYear: 1929,
            deathYear: 1998,
            primaryInvention: "Electrogasdynamic Systems",
            inventionYear: 1970,
            category: "Engineering & Safety",
            shortBio: "This African American physicist and Olympic athlete invented electrogasdynamic systems for removing smoke and fog, improving safety in buildings and transportation.",
            detailedBio: "Meredith Charles Gourdine was born in Newark, New Jersey, in 1929, and became both an Olympic athlete and a pioneering physicist. After competing in the long jump in the 1952 Olympics, he earned his PhD in engineering science from Caltech. Gourdine founded Gourdine Systems and developed electrogasdynamic (EGD) technology, which uses electrical fields to move gases and particles. His most significant invention was a system that could clear smoke from buildings during fires and fog from airport runways, potentially saving countless lives. The EGD system works by applying electrical charges to particles in smoke or fog, then using electric fields to direct these charged particles away from critical areas. Gourdine held over 70 patents and his technologies were used in applications ranging from air purification to paint spraying systems. His work in electrogasdynamics opened new possibilities for controlling airborne particles and gases in various industrial and safety applications.",
            impact: "His electrogasdynamic systems improved building safety and air quality control, with applications in fire safety and pollution control.",
            achievements: [
                "Invented electrogasdynamic smoke removal systems",
                "Olympic athlete (1952 long jump)",
                "Founded Gourdine Systems technology company",
                "Held over 70 patents in various fields",
                "Advanced air purification and safety technology"
            ],
            patents: ["U.S. Patent #3,518,462", "U.S. Patent #3,692,637"],
            viewCount: 21890,
            tags: ["electrogasdynamics", "smoke-removal", "air-purification", "building-safety", "olympic-athlete"]
        },
        {
            id: "lloyd-augustus-hall",
            name: "Lloyd Augustus Hall",
            country: "United States",
            countryCode: "US",
            flag: "🇺🇸",
            inventionEmoji: "🧂",
            ...
            birthYear: 1894,
            deathYear: 1971,
            primaryInvention: "Food Preservation Methods",
            inventionYear: 1932,
            category: "Food Science",
            shortBio: "This pioneering African American food chemist revolutionized food preservation by developing salt-based preservation methods that extended food shelf life and improved safety.",
            detailedBio: "Lloyd Augustus Hall was born in Elgin, Illinois, in 1894, and became one of the most important food scientists of the 20th century. After earning his degree in pharmaceutical chemistry from Northwestern University, Hall faced racial discrimination that prevented him from working in many laboratories. He eventually joined Griffith Laboratories in Chicago, where he spent most of his career developing revolutionary food preservation techniques. Hall's most significant contribution was the development of 'flash-dried' salt that could be combined with other preservatives to significantly extend the shelf life of meat products. He also created the use of antioxidants to prevent food spoilage and developed sterilization techniques using ethylene oxide gas. His work was crucial during World War II when preserving food for troops was essential. Hall held over 100 patents and his preservation methods are still used today in the food industry, helping to prevent foodborne illness and reduce food waste worldwide.",
            impact: "His food preservation innovations revolutionized the food industry and helped feed millions safely during wartime and peacetime.",
            achievements: [
                "Developed revolutionary salt-based food preservation",
                "Invented flash-dried salt preservation method",
                "Created sterilization techniques using ethylene oxide",
                "Held over 100 patents in food science",
                "Advanced food safety during World War II"
            ],
            patents: ["U.S. Patent #2,107,697", "U.S. Patent #2,252,117"],
            viewCount: 25670,
            tags: ["food-preservation", "salt-curing", "food-safety", "sterilization", "antioxidants"]
        },
        {
            id: "john-standard",
            name: "John Standard",
            ...
            birthYear: 1850,
            deathYear: 1900,
            primaryInvention: "Improved Refrigerator and Oil Stove",
            inventionYear: 1891,
            category: "Home Appliances",
            shortBio: "This African American inventor improved refrigerator design and developed oil stove technology that made food storage and cooking more efficient for families.",
            detailedBio: "John Standard was an African American inventor who focused on improving essential household appliances during the late 19th century. On June 14, 1891, he received U.S. Patent #455,891 for an improved refrigerator design that featured better insulation and air circulation systems. His refrigerator improvements made ice-based cooling more efficient and helped food stay fresh longer. Standard also invented an improved oil stove (U.S. Patent #413,689) on October 29, 1889, which provided safer and more efficient heating and cooking for homes. His oil stove design included better fuel regulation and safety features that reduced the risk of fires and improved heat distribution. These inventions were particularly important for working-class families who couldn't afford the latest appliances but needed reliable food storage and cooking equipment. Standard's practical improvements to everyday appliances helped make household management more efficient and safer for countless families during a period of rapid urbanization and technological change.",
            impact: "His household appliance improvements made food storage and cooking safer and more efficient for working-class families.",
            achievements: [
                "Invented improved refrigerator with better insulation",
                "Developed safer oil stove technology",
                "Advanced household appliance safety features",
                "Made appliances more accessible to working families",
                "Contributed to improved home management efficiency"
            ],
            patents: ["U.S. Patent #455,891", "U.S. Patent #413,689"],
            viewCount: 17440,
            tags: ["refrigerator", "oil-stove", "home-appliances", "food-storage", "cooking-technology"]
        },
        {
            id: "william-barry",
            name: "William Barry",
            ...
            birthYear: 1870,
            deathYear: 1930,
            primaryInvention: "Postmarking and Canceling Machine",
            inventionYear: 1899,
            category: "Postal Technology",
            shortBio: "This African American inventor developed automated mail processing equipment that revolutionized post office efficiency and mail handling.",
            detailedBio: "William Barry was an African American inventor who worked to improve postal processing technology during the late 19th century. On March 25, 1899, he received U.S. Patent #621,804 for his 'Postmarking and Canceling Machine.' Barry's invention automated the process of postmarking and canceling stamps on mail, significantly increasing the speed and efficiency of mail processing in post offices. His machine could handle large volumes of mail and apply consistent, clear postmarks while simultaneously canceling stamps to prevent reuse. The device included mechanisms for feeding mail through the system automatically and applying the appropriate postmarks based on the date and location. Barry's invention came during a period of rapidly increasing mail volume due to urbanization and improved literacy rates. His machine helped post offices handle the growing demand for mail services and established principles of automation that influenced later developments in mail processing technology. The efficiency gains from his invention helped make mail service more reliable and affordable for the general public.",
            impact: "His automated mail processing machine revolutionized post office efficiency and helped handle the growing volume of mail in America.",
            achievements: [
                "Invented automated postmarking and canceling machine",
                "Revolutionized postal processing efficiency",
                "Advanced mail handling automation",
                "Improved post office service reliability",
                "Contributed to postal technology development"
            ],
            patents: ["U.S. Patent #621,804"],
            viewCount: 15320,
            tags: ["postal-technology", "mail-processing", "postmarking", "automation", "post-office"]
        },
        {
            id: "rufus-stokes",
            name: "Rufus Stokes",
            ...
            birthYear: 1924,
            deathYear: 1986,
            primaryInvention: "Air Purification Device",
            inventionYear: 1968,
            category: "Environmental Technology",
            shortBio: "This African American inventor developed air purification and combustion systems that reduced pollution and improved air quality in urban environments.",
            detailedBio: "Rufus Stokes was born in Alabama in 1924 and became an inventor focused on environmental and combustion technology. On July 30, 1968, he received U.S. Patent #3,395,972 for his 'Air Purification Device.' Stokes's invention was designed to reduce emissions from furnaces and other combustion sources, helping to improve air quality in urban areas. His device used a combination of filtration and chemical treatment to remove pollutants from exhaust gases before they were released into the atmosphere. Stokes also developed improvements to combustion systems that made them more efficient and less polluting. His work was particularly important during the 1960s when environmental awareness was growing and cities were struggling with air pollution problems. Stokes's innovations contributed to early efforts to reduce industrial pollution and protect public health. His air purification technology helped establish principles that would later influence the development of modern emission control systems and environmental protection regulations.",
            impact: "His air purification systems helped reduce industrial pollution and contributed to early environmental protection efforts.",
            achievements: [
                "Invented air purification device for furnaces",
                "Developed combustion efficiency improvements",
                "Advanced early environmental protection technology",
                "Reduced industrial air pollution",
                "Contributed to emission control development"
            ],
            patents: ["U.S. Patent #3,395,972", "U.S. Patent #3,378,241"],
            viewCount: 19680,
            tags: ["air-purification", "emission-control", "environmental-technology", "combustion-systems", "pollution-reduction"]
        },
        {
            id: "cicely-williams",
            name: "Cicely Williams",
            country: "Jamaica",
            countryCode: "JM",
            flag: "🇯🇲",
            inventionEmoji: "👶",
            ...
            birthYear: 1893,
            deathYear: 1992,
            primaryInvention: "Kwashiorkor Treatment Protocol",
            inventionYear: 1935,
            category: "Pediatric Medicine",
            shortBio: "This pioneering Jamaican pediatrician identified and developed treatments for kwashiorkor, a protein deficiency disease, saving countless children's lives.",
            detailedBio: "Cicely Delphine Williams was born in Westmoreland Parish, Jamaica, in 1893, and became one of the most important pediatricians of the 20th century. After studying medicine at Oxford University, she worked in West Africa where she first encountered a mysterious childhood disease that local people called 'kwashiorkor.' Williams was the first medical professional to identify kwashiorkor as a distinct condition caused by protein deficiency, not infectious disease as previously thought. She developed treatment protocols using locally available protein sources and established nutritional guidelines that could be implemented in resource-limited settings. Her work led to the recognition that malnutrition was not simply about lack of food, but about lack of proper nutrition, particularly protein. Williams's treatment methods saved countless children's lives and revolutionized understanding of childhood malnutrition. She also advocated for breastfeeding and developed infant feeding guidelines that are still used today. Her work influenced global public health policy and helped establish modern nutritional science.",
            impact: "Her identification and treatment of kwashiorkor revolutionized childhood nutrition and saved millions of children worldwide.",
            achievements: [
                "First to identify kwashiorkor as protein deficiency disease",
                "Developed effective treatment protocols for malnutrition",
                "Revolutionized understanding of childhood nutrition",
                "Advanced global public health policy",
                "Promoted breastfeeding and proper infant nutrition"
            ],
            patents: ["Medical Protocol Documentation #MPD-1935-KWASH"],
            viewCount: 28450,
            tags: ["kwashiorkor", "child-nutrition", "malnutrition", "pediatric-medicine", "public-health"]
        },
        {
            id: "jose-do-patrocinio",
            ...
            birthYear: 1853,
            deathYear: 1905,
            primaryInvention: "Improved Printing Press Technology",
            inventionYear: 1885,
            category: "Publishing Technology",
            shortBio: "This Afro-Brazilian journalist and inventor developed improved printing press technology that revolutionized newspaper production and helped spread literacy.",
            detailedBio: "José Carlos do Patrocínio was born in Campos dos Goytacazes, Brazil, in 1853, to an enslaved African mother and Portuguese father. He became one of Brazil's most influential journalists and a leading voice in the abolition movement. As owner and editor of several newspapers, Patrocínio faced the challenge of producing large quantities of printed material quickly and efficiently. He developed improvements to printing press technology that allowed for faster, higher-quality newspaper production. His innovations included better ink distribution systems, improved paper feeding mechanisms, and more durable printing plates that could handle longer print runs. These technological improvements were crucial for the success of his abolitionist newspapers, which helped mobilize public opinion against slavery. Patrocínio's printing innovations also benefited other publishers and contributed to the growth of literacy in Brazil by making printed materials more affordable and widely available. His work demonstrated how technological innovation could serve social justice causes and advance democratic ideals.",
            impact: "His printing press improvements helped spread abolitionist ideas and contributed to increased literacy and democratic participation in Brazil.",
            achievements: [
                "Improved printing press technology for newspapers",
                "Advanced newspaper production efficiency",
                "Contributed to abolitionist movement through technology",
                "Promoted literacy through affordable printing",
                "Influenced democratic participation in Brazil"
            ],
            patents: ["Brazilian Patent #BR-85-PRINT"],
            viewCount: 21340,
            tags: ["printing-press", "newspaper-technology", "abolitionist", "literacy", "democratic-media"]
        }
    ],
